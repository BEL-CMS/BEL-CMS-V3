			...
			<div class="p-6">
				<div class="overflow-x-auto">
                    <div class="mt-2 mb-2">
						...
						<input value="<?=$cat->name;?>" name="name" type="text" class="form-input" id="input-name" required="required">
					</div>
					<div class="mt-2 mb-2">
						<label class="text-gray-800 text-sm font-medium inline-block mt-2 mb-2"><?=constant('CATEGORY_COLOR');?></label>
						<input data-jscolor="{reset:'small dark',value:'<?=$cat->color;?>'}" name="color" type="text" class="form-input">
					</div>
					<div class="mt-2 mb-2">
						<label class="text-gray-800 text-sm font-medium inline-block mt-2 mb-2"><?=constant('DESC');?></label>
						<textarea style="width:95%;margin:auto;" class="bel_cms_textarea_simple" name="description"><?=$cat->description;?></textarea>
					</div>
                </div>
            </div>
        </div>
