			...
			<div class="p-6">
				<div class="overflow-x-auto">
					<div>
						...
						<input name="title" value="<?=$thread->title?>" class="form-input" id="label_title" type="text" required="required" placeholder="Titre du forum">
					</div>
					<div>
						<label class="text-gray-800 text-sm font-medium inline-block mt-2 mb-2"><?=constant('SUBTITLE')?></label>
						<input name="subtitle" value="<?=$thread->subtitle?>" class="form-input" type="text" placeholder="Sous-titre du forum">
					</div>
					<div>
						<label class="text-gray-800 text-sm font-medium inline-block mt-2 mb-2"><?=constant('ORDER')?></label>
						<input value="<?=$thread->orderby?>" name="orderby" class="form-input" id="label_orderby" type="number" required="required" placeholder="1" min="1">
					</div>
					...
					<label class="text-gray-800 text-sm font-medium inline-block mt-2 mb-2"><?=constant('VIEW')?> <a target="_blank" href="https://fontawesome.com/icons?d=gallery&m=free">(<?=constant('ICON');?>)</a></label>
						<input name="icon" value="<?=$thread->icon?>" class="form-input" id="label_icon" type="text" placeholder="fa fa-code">
					</div>
