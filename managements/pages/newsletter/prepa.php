...
?>
<form action="newsletter/sendprepa?management&option=pages" method="post">
			...
			<div class="p-6">
				<div class="flex flex-col gap-2">
					<div class="form-check">
						<input type="radio" class="form-radio text-success" name="send" id="formRadio01" value="1">
					...
					?>
					<div class="form-check">
						<input type="radio" class="form-radio text-success" name="send" id="<?=$key;?>" value="group_<?=$v['id'];?>">
