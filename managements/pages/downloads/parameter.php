...
?>
<form action="/downloads/sendparameter?management&option=pages" method="post">
	<div class="flex flex-col gap-6">
		<div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
			<div class="card">
				<div class="card-header">
					<h4><?=constant('DOWNLOAD_ACTIVE');?></h4>
				</div>
				<div class="p-6">
					<div>
						...
						<div>
							<label class="text-gray-800 text-sm font-medium inline-block mt-2 mb-2" for="<?=constant('NB_DL')?>">
							<?=constant('NB_DL')?></label>
							<div class="col-sm-12">
								<input id="input-NB_BLOG" name="MAX_DL" type="number" class="form-input" type="number" value="<?=$config->config['MAX_DL']?>" min="1" max="16">
							</div>
						</div>
					</div>
				</div>
