...
<div class="card">
	...
	<div class="p-6">
		<div class="flex flex-wrap gap-x-7 gap-y-3">
			...
			?>
				<a class="relative py-2.5 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-primary text-white hover:bg-primary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800" href="page/getpage/<?=$value->id?>?management&option=pages">
				<?=$value->name;?>
