...
$checked3 = $data->cms_jquery->value   == '1' ? 'checked="checked"' : '';
$checked4 = $data->cms_highlight->value   == '1' ? 'checked="checked"' : '';
$checked5 = $data->cms_fontawsome->value   == '1' ? 'checked="checked"' : '';
?>
<form action="prefgen/send?management&option=parameter" method="post">
    <div class="flex flex-col gap-6">
        <div class="grid lg:grid-cols-2 gap-6">
            ...
            <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Activation JS</h3>
                    </div>
                    <div class="p-6">
                    <div>
                        <div class="flex items-center opacity-60">
                            <input class="form-switch" name="cms_jquery" type="checkbox" <?=$checked3;?> value="1" role="switch" id="cms_jquery">
                            <label class="ms-1.5" for="cms_jquery">Activer jQuery</label>
                        </div>
                    </div>
                    <br>
                    <div>
                        <div class="flex items-center opacity-60">
                            <input class="form-switch" name="cms_highlight" type="checkbox" <?=$checked4;?> value="1" role="switch" id="cms_highlight">
                            <label class="ms-1.5" for="cms_highlight">Activer highlight</label>
                        </div>
                    </div>
                    <br>
                    <div>
                        <div class="flex items-center opacity-60">
                            <input class="form-switch" name="cms_fontawsome" type="checkbox" <?=$checked5;?> value="1" role="switch" id="cms_fontawsome">
                            <label class="ms-1.5" for="cms_fontawsome">Activer FontAwsome</label>
                        </div>
                    </div>
                </div>
            </div>
