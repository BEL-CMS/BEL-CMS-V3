    ...
    <div id="default-offcanvas" class="lg:block hidden top-0 left-0 transform h-full min-w-[16rem] me-6 card rounded-none lg:rounded-md fc-offcanvas-open:translate-x-0 lg:z-0 z-50 fixed lg:static lg:translate-x-0 -translate-x-full transition-all duration-300" tabindex="-1">
        <div class="p-5">
            ...
            <div class="space-y-2 mt-4">
                ...
                <a href="file_manager/backup?management&option=extras" class="flex items-center py-2 px-4 text-sm rounded text-gray-500 bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:bg-gray-700 dark:hover:text-gray-300" id="headingOne">
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                                    ...
                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
                                        ...
                                        foreach ($data as $value):
                                            ...
                                            $i = $i + filesize($value);
                                            $dl = str_replace(ROOT.DS, '', $value);
                                        ?>
                                        <tr>
                                            <td class="p-3.5 text-sm text-gray-700 dark:text-gray-400">
                                                <a href="javascript: void(0);" class="font-medium"><?=$value;?></a>
                                            </td>
                                            <td class="p-3.5 text-sm text-gray-700 dark:text-gray-400">
                                                <?=$size;?>
                                            <td class="p-3.5">
