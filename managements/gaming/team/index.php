	...
	<div class="card">
		<div class="card-header">
			<div class="flex justify-between items-center">
				<h4 class="card-title"><?=constant('LIST_OF_TEAM');?></h4>
			</div>
		</div>
		<div class="p-6">
					...
					<table class="DataTableBelCMS min-w-full divide-y divide-gray-200 dark:divide-gray-700 p-2 hover cell-border stripe">
						<thead class="bg-gray-50 dark:bg-gray-700">
							<tr>
								...
								<th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase dark:text-gray-400"><?=constant('DESC');?></th>
								<th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase dark:text-gray-400"><?=constant('NB_USERS');?></th>
						...
						?>
							<tr>
								...
								<td><?=$v->count?></td>
								<td>
									<button class="btn btn-sm bg-primary text-white" onclick="window.location.href='Team/player/<?=$v->id?>?management&option=gaming'">
										<i class="mgc_user_add_fill text-base me-4"></i><?=constant('ADD_PLAYER');?>
									</button>
									<button class="btn btn-sm bg-success text-white" onclick="window.location.href='team/edit/<?=$v->id?>?management&option=gaming'">
										<i class="mgc_edit_2_fill text-base me-4"></i><?=constant('EDIT_TEAM');?>
									</button>
									...
									<div id="delete-modal_<?=$v->id?>"
										...
										<div class="fc-modal-open:opacity-100 duration-500 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto flex flex-col bg-white border shadow-sm rounded-md dark:bg-slate-800 dark:border-gray-700">
											...
											<div class="px-4 py-8 overflow-y-auto">
												...
												Confirmer la suppression de la team : <?=$v->name?>
												</p>
											</div>
											<div class="flex justify-end items-center gap-4 p-4 border-t dark:border-slate-700">
												...
												<a class="btn bg-primary text-white" onclick="window.location.href='team/del/<?=$v->id?>?management&gaming=true'"><?=constant('DELETE');?></a>
											</div>
										</div>
									</div>
								</td>
