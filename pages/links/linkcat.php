    ...
    <ul>
        ...
        <li>
            ...
            <div class="links_cat_row_one">
                <span style="text-align: left !important;"><i class="fa-solid fa-calendar-days"></i>&nbsp;<?=Common::TransformDate($v->date_insert, 'MEDIUM', 'NONE');?></span>
                <span style="text-align: left !important;"><i class="fa-solid fa-group-arrows-rotate"></i>&nbsp;<?=$v->nameCat->name;?></span>
            </div>
